...
function isBudgetedLargestJsAsset(asset: ReturnType<typeof readAssetMetrics>): boolean {
  if (asset.type !== "js") {
    return false;
  }
  return !DEFERRED_DOCUMENT_RENDERER_JS_RE.test(path.basename(asset.file));
}
