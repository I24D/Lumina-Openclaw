...
import { startLuminaVoiceReadAloud } from "../lumina/voice-read-aloud.js";
...
export function startGatewayEventSubscriptions(params: {
  ...
  // Lumina: forward finished assistant turns to the Windows Bridge voice queue
  // so Start Talk can read OpenClaw replies aloud. Self-idempotent (keeps a
  // single global subscription), so it needs no entry in the close path.
  startLuminaVoiceReadAloud();
