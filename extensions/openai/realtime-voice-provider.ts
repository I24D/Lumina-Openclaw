...
const OPENAI_REALTIME_DEFAULT_VOICE: OpenAIRealtimeVoice = "coral";
    ...
    return {
      ...
      session: {
        ...
        audio: {
          ...
          output: {
            format: this.resolveRealtimeAudioFormat(),
            voice: cfg.voice ?? OPENAI_REALTIME_DEFAULT_VOICE,
          },
        },
...
async function createOpenAIRealtimeBrowserSession(
  ...
  const voice =
    normalizeOpenAIRealtimeVoice(req.voice) ?? config.voice ?? OPENAI_REALTIME_DEFAULT_VOICE;
