  ...
  return {
    ...
    parameters: Type.Object({
      ...
      sessionId: Type.Optional(
        Type.String({ maxLength: 64, description: "Unique session identifier." }),
      ),
      userDataDir: Type.Optional(
        Type.String({
          maxLength: 512,
          description: "Custom user data directory for persistent cookies.",
        }),
      ),
      headless: Type.Optional(
        Type.Boolean({ default: true, description: "Run browser in headless mode." }),
      ),
      // For use_session
      ...
      selector: Type.Optional(
        Type.String({ maxLength: 512, description: "CSS selector for click/type actions." }),
      ),
    ...
    async execute(_id, rawParams) {
      ...
      if (action === "use_session") {
        ...
        if (
          (params.browserAction === "click" || params.browserAction === "type") &&
          !params.selector
        ) {
