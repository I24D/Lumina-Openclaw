  ...
  return {
    ...
    parameters: Type.Object({
      ...
      sessionId: Type.Optional(
        Type.String({
          maxLength: 64,
          description: "Session identifier for organizing recordings.",
        }),
      ),
      maxDurationMs: Type.Optional(
        Type.Number({ minimum: 1000, maximum: 600_000, default: 300000 }),
      ),
    ...
    async execute(_id, rawParams) {
      ...
      const payload = {
        ...
        userDataDir: baseDir,
        args: {
          outDir: params.sessionId
            ? path.join(screencastsDir(), params.sessionId)
            : screencastsDir(),
