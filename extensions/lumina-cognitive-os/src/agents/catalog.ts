...
export const SPECIALISED_AGENTS: ReadonlyArray<SpecialisedAgent> = [
  ...
  },
  {
    ...
    tools: ["lumina_browser_drive", "lumina_vision_multimonitor", "lumina_episodic_remember"],
  ...
  },
  {
    ...
    tools: ["lumina_screen_capture", "lumina_vision_ui_tree", "lumina_vision_multimonitor"],
