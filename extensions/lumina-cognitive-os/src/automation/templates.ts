...
export const INTENT_TEMPLATES: ReadonlyArray<IntentTemplate> = [
  {
    ...
    recipe: [
      { toolName: "lumina_calendar", hint: "list today's events; condense to one line each." },
      {
        ...
        hint: "list unread emails of the last 24h; flag high importance.",
      },
      {
        toolName: "lumina_episodic_recall",
        hint: "recall yesterday's open loops (tags=['todo','open']).",
      },
      {
        toolName: "lumina_working_memory_set",
        hint: "set currentIntent='daily-planning' and pin top 3 tasks.",
      },
    ],
  },
  {
    ...
    recipe: [
      {
        toolName: "lumina_gmail",
        hint: "list unread of last 48h; rank by sender importance and length.",
      },
      {
        toolName: "lumina_episodic_remember",
        hint: "log the review with tags=['email','review'].",
      },
    ],
  },
  {
    ...
    description:
      "Para cada correo no respondido, propone borrador y pide confirmación verbal antes de enviar.",
    recipe: [
      {
        toolName: "lumina_gmail",
        hint: "find threads where last message is from a contact and >24h old.",
      },
      {
        toolName: "lumina_risk_evaluate",
        hint: "category='communication' for each draft before sending.",
      },
  ...
  },
  {
    ...
    description: "Recolecta datos del proyecto activo y produce un resumen ejecutivo con cifras.",
    recipe: [
      { toolName: "lumina_working_memory_get", hint: "discover the current project." },
      {
        toolName: "lumina_file_ops",
        hint: "find files like sales*.csv, ventas*.xlsx in the project dir.",
      },
      {
        toolName: "lumina_code",
        hint: "ask the coding agent to compute aggregates and produce a one-page summary.",
      },
    ],
  },
  {
    ...
    recipe: [
      ...
      {
        toolName: "lumina_code",
        hint: "delegate the audit to the coding agent; expect a structured report.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    recipe: [
      ...
      {
        toolName: "lumina_risk_evaluate",
        hint: "category='communication' before sending the invite.",
      },
  ...
  },
  {
    ...
    recipe: [
      ...
      {
        toolName: "lumina_episodic_remember",
        hint: "log each source with tags=['research','competition'].",
      },
    ],
  },
  {
    ...
    recipe: [
      ...
      {
        toolName: "lumina_code",
        hint: "ask the coding agent to draft slides outline as markdown.",
      },
