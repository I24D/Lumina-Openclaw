...
export function createUiTreeTool(): AnyAgentTool {
  return {
    ...
    parameters: Type.Object({
      pid: Type.Optional(
        Type.Number({
          description: "Optional process ID whose top window to walk. Defaults to foreground.",
        }),
      ),
      maxDepth: Type.Optional(Type.Number({ minimum: 1, maximum: 12, default: 6 })),
      maxNodes: Type.Optional(Type.Number({ minimum: 10, maximum: 2000, default: 400 })),
    }),
