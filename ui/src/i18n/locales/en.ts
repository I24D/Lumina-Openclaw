...
export const en: TranslationMap = {
  ...
  chat: {
    ...
    composer: {
      ...
      screenShareAccessFailed: "Screen sharing could not start.",
      screenSharePermissionBlocked: "Screen sharing was blocked. Allow screen access to continue.",
      screenSharePreview: "Shared screen preview",
      screenShareUnavailable: "Screen sharing is unavailable in this browser.",
      screenSharing: "Screen shared",
      ...
      talkConversation: "Talk conversation",
      talkConversationError: "Talk needs attention",
      talkConversationSaved: "Transcript",
      talkWindowTitle: "Start Talk",
      talkWindowAnswer: "Talk answer",
      talkWindowAnswerPlaceholder: "I am listening.",
      talkWindowCameraUnavailable: "Camera is unavailable for this Talk session.",
      talkWindowClose: "Close Start Talk",
      talkWindowControls: "Start Talk controls",
      talkWindowQuestion: "Your Talk question",
      talkWindowQuestionPlaceholder: "Ask Lumina",
      talkWindowReady: "Ready",
      talkWindowShareScreen: "Share screen",
      talkWindowShareScreenUnavailable: "Screen sharing is unavailable for this Talk session.",
      talkWindowListening: "Listening...",
      talkWindowThinking: "Thinking...",
      stopSharingScreen: "Stop sharing screen",
      toggleTalkBackground: "Switch Talk background",
