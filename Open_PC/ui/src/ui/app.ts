...
import {
  loadLuminaCodeStatus as loadLuminaCodeStatusInternal,
  openLuminaCode as openLuminaCodeInternal,
...
export class OpenClawApp extends LitElement {
  ...
  protected override firstUpdated() {
    ...
    if (this.tab === "luminaCode") {
      void loadLuminaCodeStatusInternal(this);
    }
  }
  ...
  async loadLuminaCodeStatus() {
    await loadLuminaCodeStatusInternal(this);
  }

  async openLuminaCode() {
    await openLuminaCodeInternal(this);
  }
