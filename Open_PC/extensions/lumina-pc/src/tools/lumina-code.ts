...
export function createLuminaCodeTool(): AnyAgentTool {
  return {
    ...
    description:
      ...
      "For user requests to create, edit, debug, refactor, test, build, or execute development work, " +
      "use action=delegate with the user's instruction so Lumina Code opens in VS Code and starts working on it. " +
